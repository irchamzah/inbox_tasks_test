export default function Search() {
  return (
    <div className="flex border h-10 pr-20 rounded border-primary-gray">
      <input
        type="text"
        placeholder="Search"
        className="flex-grow h-full rounded-full pl-20 mr-2 text-primary-gray-dark focus:outline-none"
      />
      <button className="h-10 w-10 rounded-full flex items-center justify-center hover:opacity-70">
        <svg
          className="h-4 w-4"
          width="32"
          height="31"
