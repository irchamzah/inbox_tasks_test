export default function GroupChatIcons() {
  return (
    <div className="flex">
      <div className="bg-primary-gray-light h-[45px] w-[45px] rounded-full flex items-center justify-center">
        <svg
          className="h-7 w-7"
          width="31"
          height="31"
      ...
      <div className="bg-primary-blue h-[45px] w-[45px] rounded-full flex items-center justify-center -ml-5">
        <svg
          className="h-7 w-7"
          width="31"
          height="31"
